...
%  Origin   : Tue Oct  7 17:49:54 2018
%  Purpose  : Sample test cases for proj2
%  Copyright: (c) 2018 Peter Schachte.  All rights reserved.
%
%  The test cases that will be used for testing are different from these, but
