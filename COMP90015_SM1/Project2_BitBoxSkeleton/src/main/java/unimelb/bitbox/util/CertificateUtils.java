...
/**
 * Author: Taras
 * From: https://stackoverflow.com/questions/47816938/java-ssh-rsa-string-to-public-key
 * Usage: To transform the public key format that can be used for encryption
 */
...
//        00 c3 a3...             The modulus
    ...
    public static RSAPublicKey parseSSHPublicKey(String key) throws InvalidKeyException {
        ...
        ByteArrayInputStream is = new ByteArrayInputStream(Base64.decode(keyStr));
